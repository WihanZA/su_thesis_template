...
\newcommand*{\WaterMark}[3][0.3\paperwidth]{%
    \AddToShipoutPicture*{\AtTextCenter{%
        \parbox[t]{0pt}{\raisebox{#3}{\makebox[0pt][c]{%
            \includegraphics[width=#1]{#2}}}}}}}

\usepackage[masters-t, $if(margin-ratio)$$margin-ratio$,$endif$]{usthesis} 
% options are masters-t or PhD
...
% \SetSponsor{The financial assistance of XXXX towards this research is hereby acknowledged. Opinions expressed are those of the author and are not to be attributed to XXXX.}
...
\begin{document}
\frontmatter 
\WaterMark{./images/su_logo.jpg}{-2cm}
$if(title)$
\TitlePage
$endif$
